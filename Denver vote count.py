...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (
            f"{county_name}: {county_vote_percentage:.1f}% ({county_total:,})\n")
        ...
        if (county_total > overall_turnout):
            overall_turnout = county_total
            largest_county_turnout = county_name

    for candidate in Denver_votes:
        denver_candidate_total = Denver_votes.get(candidate)

        Denver_results = (
            f"{candidate}: {denver_candidate_total:,}")
    ...
    largest_county_turnout_summary = (
        ...
        f"-------------------------\n")
    #print(largest_county_turnout_summary, end="")
